...
data_source = 'Recieved excel file from GU, and Facility information from GU"s website uploaded by OUST'                        # Describe in detail where data came from (e.g. URL downloaded from, Excel spreadsheets from state, state API URL, etc.)
date_received = '2024-03-06'            # Defaults to datetime.today(). To use a date other than today, set as a string in the format of 'yyyy-mm-dd'.
...
comments = 'Facility Information not complete'                           # Top-level comments on the dataset. An example would be "Exclude Aboveground Storage Tanks".
