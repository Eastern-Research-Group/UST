...
organization_id = 'HI'                  # Enter the two-character code for the state, or "TRUSTD" for the tribes database 
ust_or_release = 'release'                  # Valid values are 'ust' or 'release'
data_source = 'Email on 3-5-2025 from HI with updated data (ustrac-data.mdb)'                        # Describe in detail where data came from (e.g. URL downloaded from, Excel spreadsheets from state, state API URL, etc.)
date_received = '2025-03-06'            # Defaults to datetime.today(). To use a date other than today, set as a string in the format of 'yyyy-mm-dd'.
