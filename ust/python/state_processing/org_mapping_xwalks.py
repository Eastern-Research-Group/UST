...
def main(control_id, ust_or_release):
    ...
    #print ("pop_view_name: "+pop_view_name)
    #print ("control_id_col: "+control_id_col)
    ...
    for row in rows:
        ...
        if epa_column_name == 'facility_type1' or epa_column_name == 'facility_type2':
            ...
            epa_column_name2 = database_lookup_column #epa_column_name
        ...
        #print('epa_column_name2 = '+epa_column_name2)
        #print('control_id_col = '+control_id_col)
