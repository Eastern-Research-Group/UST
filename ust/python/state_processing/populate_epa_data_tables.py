...
control_id = 18                  # Enter an integer that is the release_control_id
organization_id = ''      		# Optional; if control_id = 0 or None, will find the most recent control_id
delete_existing = True 		# can set to True if there is existing UST data you need to delete before inserting new
