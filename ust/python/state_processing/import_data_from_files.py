...
organization_id = 'DC'            # Enter the two-character code for the state, or "TRUSTD" for the tribes database 
path = r"C:\Users\cpitkins\OneDrive - Eastern Research Group\Desktop\UST\DC\Release"                    # Enter the full path to the directory containing the source data file(s) (NOT a path to a specific file)
