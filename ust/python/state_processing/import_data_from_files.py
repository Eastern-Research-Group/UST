...
path = r"C:\Users\cpitkins\OneDrive - Eastern Research Group\Desktop\UST\Hawaii_new"                      # Enter the full path to the directory containing the source data file(s) (NOT a path to a specific file)
