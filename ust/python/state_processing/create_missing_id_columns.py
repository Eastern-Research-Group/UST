...
control_id = 40                   # Enter an integer that is the release_control_id
table_name = 'ust_tank_dispenser'               # Optional; enter the table name that contains the missing ID column. If None, the script will identify all tables that require an ID column.
