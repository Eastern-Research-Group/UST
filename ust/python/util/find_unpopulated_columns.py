...
schema = 'de_release' 			# Set to the schema name
table_name = 'Template'		# If None, will check all tables in the specified schema. Set variable to a single table name to check a specific table. 
