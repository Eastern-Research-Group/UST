...
class ImportService:
    ...
    def import_data(self, organization_id, ust_or_release, file_path, overwrite_table=True, table_name=None):
        importer = DatabaseImporter(organization_id, ust_or_release, file_path, overwrite_table, table_name)
        importer.save_files_to_db()
