...
class Dataset:
	def __init__(self, 
			...
			self.organization_id = 'XX' # utils.get_org_from_control_id(self.control_id, self.ust_or_release)
			self.schema = 'example' # utils.get_schema_from_control_id(self.control_id, self.ust_or_release)
