...
values ('DE', '2024-03-01', current_date, 'Source Data from an EPA template populated by the state', 'Some mapping done by ERG', 'Y')
 ...
 * Do a global replace in this script from 29 to the new ust_control_id.
 */
------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
where table_schema = lower('de_ust') order by 1;
...
where table_schema = lower('de_ust') 
order by table_name, ordinal_position;
...
values (29,'ust_facility','facility_id','facility','FacilityID',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments)
values (29,'ust_facility','facility_name','facility','FacilityName',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_facility','owner_type_id','facility','OwnerType',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_facility','facility_type1','facility','FacilityType1',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_facility','facility_address1','facility','FacilityAddress1',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_facility','facility_address2','facility','FacilityAddress2',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_facility','facility_city','facility','FacilityCity',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_facility','facility_county','facility','FacilityCounty',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_facility','facility_zip_code','facility','FacilityZipCode',null);
...
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_facility','facility_state','facility','FacilityState',null);
...
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_facility','facility_epa_region','facility','FacilityEPARegion',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_facility','facility_latitude','facility','FacilityLatitude',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_facility','facility_longitude','facility','FacilityLongitude',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_facility','coordinate_source_id','facility','FacilityCoordinateSource',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_facility','facility_owner_company_name','facility','FacilityOwnerCompanyName',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_facility','facility_operator_company_name','facility','FacilityOperatorCompanyName',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_facility','financial_responsibility_obtained','facility','FinancialResponsibilityObtained',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_facility','financial_responsibility_bond_rating_test','facility','FinancialResponsibilityBondRatingTest',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_facility','financial_responsibility_commercial_insurance','facility','FinancialResponsibilityCommercialInsurance',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_facility','financial_responsibility_guarantee','facility','FinancialResponsibilityGuarantee',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_facility','financial_responsibility_letter_of_credit','facility','FinancialResponsibilityLetterOfCredit',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_facility','financial_responsibility_local_government_financial_test','facility','FinancialResponsibilityLocalGovernmentFinancialTest',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_facility','financial_responsibility_self_insurance_financial_test','facility','FinancialResponsibilitySelfInsuranceFinancialTest',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_facility','financial_responsibility_state_fund','facility','FinancialResponsibilityStateFund',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_facility','financial_responsibility_surety_bond','facility','FinancialResponsibilitySuretyBond',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_facility','financial_responsibility_trust_fund','facility','FinancialResponsibilityTrustFund',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_facility','ust_reported_release','facility','USTReportedRelease',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_facility','associated_ust_release_id','facility','AssociatedLUSTID',null);
...
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_tank','facility_id','tank','FacilityID',null);
...
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_tank','tank_id','tank','TankID',null);
...
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_tank','tank_name','tank','TankName',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_tank','tank_location_id','tank','TankLocation',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_tank','tank_status_id','tank','TankStatus',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_tank','federally_regulated','tank','FederallyRegulated',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_tank','field_constructed','tank','FieldConstructed',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_tank','emergency_generator','tank','EmergencyGenerator',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_tank','airport_hydrant_system','tank','AirportHydrantSystem',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_tank','multiple_tanks','tank','MultipleTanks',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_tank','tank_closure_date','tank','TankClosureDate',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_tank','tank_installation_date','tank','TankInstallationDate',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_tank','compartmentalized_ust','tank','CompartmentalizedUST',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_tank','number_of_compartments','tank','NumberOfCompartments',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_tank','tank_material_description_id','tank','TankMaterialDescription',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_tank','tank_corrosion_protection_sacrificial_anode','tank','TankCorrosionProtectionSacrificialAnode',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_tank','tank_corrosion_protection_impressed_current','tank','TankCorrosionProtectionImpressedCurrent',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_tank','tank_corrosion_protection_cathodic_not_required','tank','TankCorrosionProtectionCathodicNotRequired',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_tank','tank_corrosion_protection_interior_lining','tank','TankCorrosionProtectionInteriorLining',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_tank','tank_corrosion_protection_other','tank','TankCorrosionProtectionOther',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_tank','tank_corrosion_protection_unknown','tank','TankCorrosionProtectionUnknown',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_tank','tank_secondary_containment_id','tank','TankSecondaryContainment',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_tank','cert_of_installation','tank','CertOfInstallation',null);

--ust_tank_substance: This table is OPTIONAL (but most states will have data)
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_tank_substance','facility_id','compartment','FacilityID',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_tank_substance','tank_id','compartment','TankID',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_tank_substance','tank_name','compartment','TankName',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_tank_substance','substance_id','compartment','CompartmentSubstanceStored',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_tank_substance','substance_casno','compartment','CompartmentSubstanceCASNO',null);
...
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_compartment','facility_id','compartment','FacilityID',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_compartment','tank_id','compartment','TankID',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_compartment','tank_name','compartment','TankName',null);
...
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_compartment','compartment_id','compartment','CompartmentID',null);
--NOTE: Use compartment_id for numeric fields and compartment_name for alphanumeric/text fields. 
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_compartment','compartment_name','compartment','CompartmentName',null);
...
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_compartment','compartment_status_id','compartment','CompartmentStatus',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_compartment','compartment_capacity_gallons','compartment','CompartmentCapacityGallons',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_compartment','null','compartment','OverfillPreventionBallFloatValve','All State Values were Unknown, assumed state did not record data.');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_compartment','null','compartment','OverfillPreventionFlowShutoffDevice','All State Values were Unknown, assumed state did not record data.');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_compartment','null','compartment','OverfillPreventionHighLevelAlarm','All State Values were Unknown, assumed state did not record data.');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_compartment','overfill_prevention_other','compartment','OverfillPreventionOther',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_compartment','overfill_prevention_unknown','compartment','OverfillPreventionUnknown',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_compartment','overfill_prevention_not_required','compartment','OverfillPreventionNotRequired',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_compartment','spill_bucket_installed','compartment','SpillBucketInstalled',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_compartment','concrete_berm_installed','compartment','ConcreteBermInstalled',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_compartment','spill_prevention_other','compartment','SpillPreventionOther',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_compartment','spill_prevention_not_required','compartment','SpillPreventionNotRequired',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_compartment','null','compartment','SpillBucketWallType','All State Values were Unknown, assumed state did not record data.');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_compartment','tank_interstitial_monitoring','compartment','TankInterstitialMonitoring',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_compartment','tank_automatic_tank_gauging_release_detection','compartment','TankAutomaticTankGaugingReleaseDetection',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_compartment','automatic_tank_gauging_continuous_leak_detection','compartment','AutomaticTankGaugingContinuousLeakDetection',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_compartment','tank_manual_tank_gauging','compartment','TankManualTankGauging',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_compartment','tank_statistical_inventory_reconciliation','compartment','TankStatisticalInventoryReconciliation',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_compartment','tank_tightness_testing','compartment','TankTightnessTesting',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_compartment','tank_inventory_control','compartment','TankInventoryControl',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_compartment','tank_groundwater_monitoring','compartment','TankGroundwaterMonitoring',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_compartment','tank_vapor_monitoring','compartment','TankVaporMonitoring',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_compartment','tank_subpart_k_tightness_testing','compartment','TankSubpartKTightnessTesting',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_compartment','tank_subpart_k_other','compartment','TankSubpartKOther',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_compartment','tank_other_release_detection','compartment','TankOtherReleaseDetection',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_compartment_substance','facility_id','compartment','FacilityID',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_compartment_substance','tank_id','compartment','TankID',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_compartment_substance','compartment_id','compartment','CompartmentID',null);

--ust_piping: This table is OPTIONAL, do not map if there is no piping data in the source data
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_piping','facility_id','piping','FacilityID',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_piping','tank_id','piping','TankID',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_piping','tank_name','piping','TankName',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_piping','compartment_id','piping','CompartmentID',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_piping','compartment_name','piping','CompartmentName',null);
...
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_piping','piping_style_id','piping','PipingStyle',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_piping','safe_suction','piping','SafeSuction',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_piping','american_suction','piping','AmericanSuction',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_piping','high_pressure_or_bulk_piping','piping','HighPressureOrBulkPiping',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_piping','piping_material_frp','piping','PipingMaterialFRP',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_piping','piping_material_gal_steel','piping','PipingMaterialGalSteel',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_piping','piping_material_stainless_steel','piping','PipingMaterialStainlessSteel',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_piping','piping_material_steel','piping','PipingMaterialSteel',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_piping','piping_material_copper','piping','PipingMaterialCopper',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_piping','piping_material_flex','piping','PipingMaterialFlex',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_piping','piping_material_no_piping','piping','PipingMaterialNoPiping',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_piping','piping_material_other','piping','PipingMaterialOther',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_piping','piping_material_unknown','piping','PipingMaterialUnknown',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_piping','null','piping','PipingFlexConnector','All State Values were Unknown, assumed state did not record data.');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_piping','piping_corrosion_protection_sacrificial_anode','piping','PipingCorrosionProtectionSacrificialAnode',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_piping','piping_corrosion_protection_impressed_current','piping','PipingCorrosionProtectionImpressedCurrent',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_piping','piping_corrosion_protection_cathodic_not_required','piping','PipingCorrosionProtectionCathodicNotRequired',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_piping','piping_corrosion_protection_other','piping','PipingCorrosionProtectionOther',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_piping','piping_corrosion_protection_unknown','piping','PipingCorrosionProtectionUnknown',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_piping','piping_line_leak_detector','piping','PipingLineLeakDetector',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_piping','piping_automated_intersticial_monitoring','piping','PipingAutomatedIntersticialMonitoring',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_piping','piping_line_test_annual','piping','PipingLineTestAnnual',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_piping','piping_line_test3yr','piping','PipingLineTest3yr',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_piping','piping_groundwater_monitoring','piping','PipingGroundwaterMonitoring',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_piping','piping_vapor_monitoring','piping','PipingVaporMonitoring',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_piping','piping_interstitial_monitoring','piping','PipingInterstitialMonitoring',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_piping','piping_statistical_inventory_reconciliation','piping','PipingStatisticalInventoryReconciliation',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_piping','piping_release_detection_other','piping','PipingReleaseDetectionOther',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_piping','piping_subpart_k_line_test','piping','PipingSubpartKLineTest',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_piping','piping_subpart_k_other','piping','PipingSubpartKOther',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_piping','pipe_tank_top_sump','piping','PipeTankTopSump',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_piping','null','piping','PipeTankTopSumpWallType','All State Values were Unknown, assumed state did not record data.');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_piping','piping_wall_type_id','piping','PipingWallType',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_piping','pipe_trench_liner','piping','PipeTrenchLiner',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_piping','pipe_secondary_containment_other','piping','PipeSecondaryContainmentOther',null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) 
values (29,'ust_piping','pipe_secondary_containment_unknown','piping','PipeSecondaryContainmentUnknown',null);

update ust_element_mapping 
set query_logic = 'When OverfillPreventionOther = Yes then Yes, when OverfillPreventionOther = No then No, else Unknown'
where ust_element_mapping_id = 2195;

update ust_element_mapping 
set query_logic = 'when SpillBucketInstalled = Yes then Yes, else No'
where ust_element_mapping_id = 2198;

update ust_element_mapping 
set query_logic = 'when FinancialResponsibilityBondRatingTest = YES then Yes, else No'
where ust_element_mapping_id = 2146;

update ust_element_mapping 
set query_logic = 'when FinancialResponsibilityCommercialInsurance = YES then Yes, else No'
where ust_element_mapping_id = 2147;

update ust_element_mapping 
set query_logic = 'when FinancialResponsibilityGuarantee = YES then Yes, else No'
where ust_element_mapping_id = 2148;

update ust_element_mapping 
set query_logic = 'when FinancialResponsibilityLetterOfCredit = YES then Yes, else No'
where ust_element_mapping_id = 2149;

update ust_element_mapping 
set query_logic = 'when FinancialResponsibilityLocalGovernmentFinancialTest = YES then Yes, else No'
where ust_element_mapping_id = 2150;

update ust_element_mapping 
set query_logic = 'when FinancialResponsibilityObtained = Yes then Yes, when FinancialResponsibilityObtained = No then No, else Unknown'
where ust_element_mapping_id = 2145;

update ust_element_mapping 
set query_logic = 'when FinancialResponsibilitySelfInsuranceFinancialTest = YES then Yes, else No'
where ust_element_mapping_id = 2151;

update ust_element_mapping 
set query_logic = 'when FinancialResponsibilityStateFund = Yes then Yes, when FinancialResponsibilityStateFund = No then No, else Unknown'
where ust_element_mapping_id = 2152;

update ust_element_mapping 
set query_logic = 'when FinancialResponsibilitySuretyBond = YES then Yes, else No'
where ust_element_mapping_id = 2153;

update ust_element_mapping 
set query_logic = 'when FinancialResponsibilityTrustFund = YES then Yes, else No'
where ust_element_mapping_id = 2154;

update ust_element_mapping 
set query_logic = 'when USTReportedRelease = Yes then Yes, else Unknown'
where ust_element_mapping_id = 2155;
...
select epa_column_name from 
	...
	where ust_control_id = 29 and mapping_complete = 'N'
...
where ust_control_id = 29 and organization_table_name like 'erg%'
order by sort_order;
...
select comments from public.ust_control where ust_control_id = 29;
