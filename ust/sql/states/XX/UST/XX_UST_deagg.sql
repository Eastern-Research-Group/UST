...
* After running deagg_example.py, run the SQL below to view the value deagg table:
*/
select * from example.erg_tank_substance_deagg order by 2;

/* Next, run script deagg_rows_example.py to crosswalk the deaggreated value to facility, tank, or compartment-level rows.
 ...
 * After running deagg_rows_example.py, run the SQL below to view the rows deagg table:
 */
