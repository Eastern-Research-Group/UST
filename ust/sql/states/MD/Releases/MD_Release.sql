...
select count(*) from md_release_combined;
...
union
select * from "All_Cases_Request__9") a
where (upper(trim("STATUS"))<>'CANCELLED' or "STATUS" is null)
and "RELEASE" = 'YES' and "CODE" like 'B%';


create table md_supp_tank_data as
select distinct "FacilityID","FacilityDesc" from md_ust.md_supp_tank_data mstd 
where "FacilityID"::text in (select "REG_NUMBER" from md_release_combined)
...
insert into release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (8,'ust_release','facility_type_id','md_supp_tank_data','FacilityDesc',null);
md_supp_tank_data
select * from release_element_mapping where release_control_id = 8
...
where release_control_id = 8 and epa_column_name = 'facility_type_id';

--paste the insert_sql from the first row below, then run the query:
select distinct 
	'insert into release_element_value_mapping (release_element_mapping_id, organization_value, epa_value, programmer_comments) values (' || 518 || ', ''' || "FacilityDesc" || ''', '''', null);'
from md_release."md_supp_tank_data" order by 1;

insert into release_element_value_mapping (release_element_mapping_id, organization_value, epa_value, programmer_comments) values (518, 'Air Taxi (Airline)', 'Aviation/airport (non-rental car)', null);
insert into release_element_value_mapping (release_element_mapping_id, organization_value, epa_value, programmer_comments) values (518, 'Apartment/Condo', 'Residential', null);
insert into release_element_value_mapping (release_element_mapping_id, organization_value, epa_value, programmer_comments) values (518, 'Auto Dealership', 'Auto dealership/auto maintenance & repair', null);
insert into release_element_value_mapping (release_element_mapping_id, organization_value, epa_value, programmer_comments) values (518, 'Church', 'Other', null);
insert into release_element_value_mapping (release_element_mapping_id, organization_value, epa_value, programmer_comments) values (518, 'Commercial', 'Commercial', null);
insert into release_element_value_mapping (release_element_mapping_id, organization_value, epa_value, programmer_comments) values (518, 'Contractor', 'Contractor', null);
insert into release_element_value_mapping (release_element_mapping_id, organization_value, epa_value, programmer_comments) values (518, 'Educational', 'School', null);
insert into release_element_value_mapping (release_element_mapping_id, organization_value, epa_value, programmer_comments) values (518, 'Exempt Commercial', 'Commercial', null);
insert into release_element_value_mapping (release_element_mapping_id, organization_value, epa_value, programmer_comments) values (518, 'Farm', 'Agricultural/farm', null);
insert into release_element_value_mapping (release_element_mapping_id, organization_value, epa_value, programmer_comments) values (518, 'Federal Military', 'Military', null);
insert into release_element_value_mapping (release_element_mapping_id, organization_value, epa_value, programmer_comments) values (518, 'Federal Non-Military', 'Federal government, non-military', null);
insert into release_element_value_mapping (release_element_mapping_id, organization_value, epa_value, programmer_comments) values (518, 'Fire/Rescue/Ambulance', 'State/local government', null);
insert into release_element_value_mapping (release_element_mapping_id, organization_value, epa_value, programmer_comments) values (518, 'Gas Station', 'Retail fuel sales (non-marina)', null);
insert into release_element_value_mapping (release_element_mapping_id, organization_value, epa_value, programmer_comments) values (518, 'Health Care', 'Hospital (or other medical)', null);
insert into release_element_value_mapping (release_element_mapping_id, organization_value, epa_value, programmer_comments) values (518, 'Hotel/Motel', 'Commercial', null);
insert into release_element_value_mapping (release_element_mapping_id, organization_value, epa_value, programmer_comments) values (518, 'Industrial', 'Industrial', null);
insert into release_element_value_mapping (release_element_mapping_id, organization_value, epa_value, programmer_comments) values (518, 'Local Government', 'State/local government', null);
insert into release_element_value_mapping (release_element_mapping_id, organization_value, epa_value, programmer_comments) values (518, 'Marina', 'Marina', null);
insert into release_element_value_mapping (release_element_mapping_id, organization_value, epa_value, programmer_comments) values (518, 'Not Listed', 'Unknown', null);
insert into release_element_value_mapping (release_element_mapping_id, organization_value, epa_value, programmer_comments) values (518, 'Office', 'Commercial', null);
insert into release_element_value_mapping (release_element_mapping_id, organization_value, epa_value, programmer_comments) values (518, 'Other', 'Other', null);
insert into release_element_value_mapping (release_element_mapping_id, organization_value, epa_value, programmer_comments) values (518, 'Petroleum Distributor', 'Bulk plant storage/petroleum distributor', null);
insert into release_element_value_mapping (release_element_mapping_id, organization_value, epa_value, programmer_comments) values (518, 'Railroad', 'Railroad', null);
insert into release_element_value_mapping (release_element_mapping_id, organization_value, epa_value, programmer_comments) values (518, 'Residential', 'Residential', null);
insert into release_element_value_mapping (release_element_mapping_id, organization_value, epa_value, programmer_comments) values (518, 'Restaurant', 'Commercial', null);
insert into release_element_value_mapping (release_element_mapping_id, organization_value, epa_value, programmer_comments) values (518, 'State Government', 'State/local government', null);
insert into release_element_value_mapping (release_element_mapping_id, organization_value, epa_value, programmer_comments) values (518, 'Store', 'Commercial', null);
insert into release_element_value_mapping (release_element_mapping_id, organization_value, epa_value, programmer_comments) values (518, 'Truck/Transporter', 'Trucking/transport/fleet operation', null);
insert into release_element_value_mapping (release_element_mapping_id, organization_value, epa_value, programmer_comments) values (518, 'Utilities', 'Utility', null);
...
insert into release_element_value_mapping (release_element_mapping_id, organization_value, epa_value, programmer_comments) values (241, 'OPEN', 'Active: general / open release', null);

delete from release_element_value_mapping where release_element_mapping_id = 241;
...
update release_element_value_mapping set epa_value = 'Other', programmer_comments=null, epa_comments = 'Sue: Did MD provide the note?  Tom:  I would make this "Other"'
where organization_value= 'SEE NOTE' ;


select * from release_element_value_mapping where organization_value= 'SEE NOTE' ; 
...
NOTE! The view queried below (v_release_table_population_sql) contains columns that help
      ...
      are used!!*/
select organization_table_name_qtd, selected_column, 
...
left join md_release.md_supp_tank_data mstd on x."REG_NUMBER"::text=mstd."FacilityID"::text
left join md_release.v_facility_type_xwalk vftx on mstd."FacilityDesc" = vftx.organization_value
left join md_release.v_release_status_xwalk	rs on x."STATUS" = rs.organization_value 
where "RELEASE" = 'YES' and "CODE" like 'B%';

select * from md_supp_tank_data;

select distinct "STATUS" from md_release_combined
where "RELEASE" = 'YES' and "CODE" like 'B%'
and (upper(trim("STATUS"))<>'CANCELLED' or "STATUS" is null);

select * from md_release_combined where "ADDRESS" = '5111 NORTH POINT BLVD';

select * from md_release_combined
--review: 
