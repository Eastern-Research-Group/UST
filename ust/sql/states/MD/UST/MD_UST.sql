...
--tables to use
select count(*) from md_facility_combined; --distinct fac
...
insert into ust_element_value_mapping (ust_element_mapping_id, organization_value, epa_value, programmer_comments) values (1051, 'Lined Interior', 'Other', 'Please verify');
insert into ust_element_value_mapping (ust_element_mapping_id, organization_value, epa_value, programmer_comments) values (1051, 'Lined Interior w/ Impressed Current', 'Other', 'Please verify');
...
select count(*) from v_ust_tank;60847
