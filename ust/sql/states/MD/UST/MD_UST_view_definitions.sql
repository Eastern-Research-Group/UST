...
create or replace view md_ust.v_ust_facility as
 ...
 and x."FacilityID"::varchar(50) not in (select facility_id from md_ust.erg_unregulated_facilities);
...
create or replace view md_ust.v_ust_tank as
 ...
 and not exists
	(select 1 from md_ust.erg_unregulated_tanks unreg
...
create or replace view md_ust.v_ust_compartment_substance as
 ...
 and not exists
	(select 1 from md_ust.erg_unregulated_tanks unreg
	where c."facility_id"::varchar(50) = unreg.facility_id and c."tank_id"::int = unreg.tank_id);
