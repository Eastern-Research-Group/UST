...
values ('SD',current_date,current_date,'Search by county here https://apps.sd.gov/NR42InteractiveMap# and download each counties by using the "download results button" and pull the facility data out of the https://arcgis.sd.gov/arcgis/rest/services/DENR/NR42_SpillReports_Public/MapServer/0 layer using ArcGIS Pro.  ','');
*/

--the script above returned a new release_control_id of 4 for this dataset:
select * from public.release_control where release_control_id = 4;
...
select * from "SpillReports"
union 
select * from "SpillReports_(1)";


insert into spill_reports_all select * from "SpillReports";
insert into spill_reports_all select * from "SpillReports_(1)";
insert into spill_reports_all select * from "SpillReports_(2)";
insert into spill_reports_all select * from "SpillReports_(3)";
insert into spill_reports_all select * from "SpillReports_(4)";
insert into spill_reports_all select * from "SpillReports_(5)";
insert into spill_reports_all select * from "SpillReports_(6)";
insert into spill_reports_all select * from "SpillReports_(7)";
insert into spill_reports_all select * from "SpillReports_(8)";
insert into spill_reports_all select * from "SpillReports_(9)";
insert into spill_reports_all select * from "SpillReports_(10)";
insert into spill_reports_all select * from "SpillReports_(11)";
insert into spill_reports_all select * from "SpillReports_(12)";
insert into spill_reports_all select * from "SpillReports_(13)";
insert into spill_reports_all select * from "SpillReports_(14)";
insert into spill_reports_all select * from "SpillReports_(15)";
insert into spill_reports_all select * from "SpillReports_(16)";
insert into spill_reports_all select * from "SpillReports_(17)";
insert into spill_reports_all select * from "SpillReports_(18)";
insert into spill_reports_all select * from "SpillReports_(19)";
insert into spill_reports_all select * from "SpillReports_(20)";
insert into spill_reports_all select * from "SpillReports_(21)";
insert into spill_reports_all select * from "SpillReports_(22)";
insert into spill_reports_all select * from "SpillReports_(23)";
insert into spill_reports_all select * from "SpillReports_(24)";
insert into spill_reports_all select * from "SpillReports_(25)";
insert into spill_reports_all select * from "SpillReports_(26)";
insert into spill_reports_all select * from "SpillReports_(27)";
insert into spill_reports_all select * from "SpillReports_(28)";
insert into spill_reports_all select * from "SpillReports_(29)";
insert into spill_reports_all select * from "SpillReports_(30)";
insert into spill_reports_all select * from "SpillReports_(31)";
insert into spill_reports_all select * from "SpillReports_(32)";
insert into spill_reports_all select * from "SpillReports_(33)";
insert into spill_reports_all select * from "SpillReports_(34)";
insert into spill_reports_all select * from "SpillReports_(35)";
insert into spill_reports_all select * from "SpillReports_(36)";
insert into spill_reports_all select * from "SpillReports_(37)";
insert into spill_reports_all select * from "SpillReports_(38)";
insert into spill_reports_all select * from "SpillReports_(39)";
insert into spill_reports_all select * from "SpillReports_(40)";
insert into spill_reports_all select * from "SpillReports_(41)";
insert into spill_reports_all select * from "SpillReports_(42)";
insert into spill_reports_all select * from "SpillReports_(43)";
insert into spill_reports_all select * from "SpillReports_(44)";
insert into spill_reports_all select * from "SpillReports_(45)";
insert into spill_reports_all select * from "SpillReports_(46)";
insert into spill_reports_all select * from "SpillReports_(47)";
insert into spill_reports_all select * from "SpillReports_(48)";
insert into spill_reports_all select * from "SpillReports_(49)";
insert into spill_reports_all select * from "SpillReports_(50)";
insert into spill_reports_all select * from "SpillReports_(51)";
insert into spill_reports_all select * from "SpillReports_(52)";
insert into spill_reports_all select * from "SpillReports_(53)";
insert into spill_reports_all select * from "SpillReports_(54)";
insert into spill_reports_all select * from "SpillReports_(55)";
insert into spill_reports_all select * from "SpillReports_(56)";
insert into spill_reports_all select * from "SpillReports_(57)";
insert into spill_reports_all select * from "SpillReports_(58)";
insert into spill_reports_all select * from "SpillReports_(59)";
insert into spill_reports_all select * from "SpillReports_(60)";
insert into spill_reports_all select * from "SpillReports_(61)";
insert into spill_reports_all select * from "SpillReports_(62)";
insert into spill_reports_all select * from "SpillReports_(63)";
insert into spill_reports_all select * from "SpillReports_(64)";
insert into spill_reports_all select * from "SpillReports_(65)";
insert into spill_reports_all select * from "SpillReports_(66)";
insert into spill_reports_all select * from "SpillReports_(67)";


update spill_reports_all
set material = trim(material);
...
insert into release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (4,'ust_release','facility_id','spill_reports_all','siteid',null);
insert into release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (4,'ust_release','release_id','spill_reports_all','id',null);
insert into release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (4,'ust_release','federally_reportable_release','spill_reports_all','regulated','Please verify');
insert into release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (4,'ust_release','site_name','spill_reports_all','site_name',null);
insert into release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (4,'ust_release','site_address','spill_reports_all','street',null);
insert into release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (4,'ust_release','site_city','spill_reports_all','city',null);
insert into release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (4,'ust_release','zipcode','spill_reports_all','zip_code',null);
insert into release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (4,'ust_release','county','spill_reports_all','county',null);
insert into release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (4,'ust_release','facility_type_id','spill_reports_all','proptype',null);
insert into release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (4,'ust_release','latitude','spill_reports_all','latitude',null);
insert into release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (4,'ust_release','longitude','spill_reports_all','longitude',null);

insert into release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (4,'ust_release','release_status_id','spill_reports_all','status',null);
insert into release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (4,'ust_release','reported_date','spill_reports_all','date_rep',null);
insert into release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (4,'ust_release','nfa_date','spill_reports_all','date_close','Please verify');

insert into release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (4,'ust_release_substance','release_id','spill_reports_all','id',null);
insert into release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (4,'ust_release_substance','substance_id','spill_reports_all','material',null);
insert into release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (4,'ust_release_substance','quantity_released','spill_reports_all','amount',null);
insert into release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (4,'ust_release_substance','unit','spill_reports_all','units',null);

insert into release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (4,'ust_release_cause','release_id','spill_reports_all','id',null);
insert into release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (4,'ust_release_cause','cause_id','spill_reports_all','cause_type',null);
...
from v_release_needed_mapping 
where release_control_id = 4 and epa_column_name = 'facility_type_id';
...
where release_control_id = 4 and epa_column_name = 'ust_release_cause'
...
where release_control_id = 4 order by 1, 2;
...
select comments from release_control where release_control_id = 4;
