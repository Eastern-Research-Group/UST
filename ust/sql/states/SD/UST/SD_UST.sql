...
insert into ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (9,'ust_compartment','tank_interstitial_monitoring','tanks','TankReleaseDetection',null);
insert into ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (9,'ust_compartment','tank_automatic_tank_gauging_release_detection','tanks','TankReleaseDetection',null);
insert into ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (9,'ust_compartment','automatic_tank_gauging_continuous_leak_detection','tanks','TankReleaseDetection',null);
insert into ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (9,'ust_compartment','tank_manual_tank_gauging','tanks','TankReleaseDetection',null);
insert into ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (9,'ust_compartment','tank_statistical_inventory_reconciliation','tanks','TankReleaseDetection',null);
insert into ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (9,'ust_compartment','tank_tightness_testing','tanks','TankReleaseDetection',null);
insert into ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (9,'ust_compartment','tank_inventory_control','tanks','TankReleaseDetection',null);
insert into ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (9,'ust_compartment','tank_groundwater_monitoring','tanks','TankReleaseDetection',null);
insert into ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (9,'ust_compartment','tank_vapor_monitoring','tanks','TankReleaseDetection',null);
insert into ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (9,'ust_compartment','tank_other_release_detection','tanks','TankReleaseDetection',null);
...
insert into ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (9,'ust_piping','piping_material_frp','tanks','TankPipingMaterial',null);
insert into ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (9,'ust_piping','piping_material_gal_steel','tanks','TankPipingMaterial',null);
insert into ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (9,'ust_piping','piping_material_stainless_steel','tanks','TankPipingMaterial',null);
insert into ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (9,'ust_piping','piping_material_steel','tanks','TankPipingMaterial',null);
insert into ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (9,'ust_piping','piping_material_copper','tanks','TankPipingMaterial',null);
insert into ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (9,'ust_piping','piping_material_flex','tanks','TankPipingMaterial',null);
insert into ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (9,'ust_piping','piping_material_no_piping','tanks','TankPipingMaterial',null);
insert into ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (9,'ust_piping','piping_material_other','tanks','TankPipingMaterial',null);
insert into ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (9,'ust_piping','piping_material_unknown','tanks','TankPipingMaterial',null);
insert into ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (9,'ust_piping','piping_groundwater_monitoring','tanks','TankPipingReleaseDetection',null);
insert into ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (9,'ust_piping','piping_vapor_monitoring','tanks','TankPipingReleaseDetection',null);
insert into ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (9,'ust_piping','piping_interstitial_monitoring','tanks','TankPipingReleaseDetection',null);
insert into ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (9,'ust_piping','piping_statistical_inventory_reconciliation','tanks','TankPipingReleaseDetection',null);
insert into ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (9,'ust_piping','piping_release_detection_other','tanks','TankPipingReleaseDetection',null);
insert into ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (9,'ust_piping','piping_wall_type_id','tanks','TankPipingReleaseDetection',null);
insert into ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (9,'ust_piping','pipe_secondary_containment_other','tanks','TankPipingReleaseDetection',null);
insert into ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments) values (9,'ust_piping','pipe_secondary_containment_unknown','tanks','TankPipingReleaseDetection',null);
...
insert into ust_element_value_mapping (ust_element_mapping_id, organization_value, epa_value, programmer_comments) values (729, 'Hydraulic Fluid', 'Other', null);
...
insert into ust_element_value_mapping (ust_element_mapping_id, organization_value, epa_value, programmer_comments) values (727, 'DW/Fbrgls/Compart', 'Other', 'Please verify.');
insert into ust_element_value_mapping (ust_element_mapping_id, organization_value, epa_value, programmer_comments) values (727, 'DW/Fiberglass', 'Other', 'Please verify.');
insert into ust_element_value_mapping (ust_element_mapping_id, organization_value, epa_value, programmer_comments) values (727, 'DW/Steel', 'Steel (NEC)', 'Please verify.');
insert into ust_element_value_mapping (ust_element_mapping_id, organization_value, epa_value, programmer_comments) values (727, 'DW/Steel/Horizontal', 'Steel (NEC)','Please verify.');
insert into ust_element_value_mapping (ust_element_mapping_id, organization_value, epa_value, programmer_comments) values (727, 'DW/STIP3', 'Other','Please verify.');
insert into ust_element_value_mapping (ust_element_mapping_id, organization_value, epa_value, programmer_comments) values (727, 'DW/STIP3/Compart', 'Other', 'Please verify.');
insert into ust_element_value_mapping (ust_element_mapping_id, organization_value, epa_value, programmer_comments) values (727, 'Fiberglass', 'Other', 'Please verify.');
insert into ust_element_value_mapping (ust_element_mapping_id, organization_value, epa_value, programmer_comments) values (727, 'Fiberglass/compart', 'Other', 'Please verify.');
insert into ust_element_value_mapping (ust_element_mapping_id, organization_value, epa_value, programmer_comments) values (727, 'HDPE', 'Other', 'Please verify.');
insert into ust_element_value_mapping (ust_element_mapping_id, organization_value, epa_value, programmer_comments) values (727, 'Lined Interior', 'Other', 'Please verify.');
insert into ust_element_value_mapping (ust_element_mapping_id, organization_value, epa_value, programmer_comments) values (727, 'Lined w/ Impressed', 'Other', 'Please verify.');
insert into ust_element_value_mapping (ust_element_mapping_id, organization_value, epa_value, programmer_comments) values (727, 'Other', 'Other', '');
insert into ust_element_value_mapping (ust_element_mapping_id, organization_value, epa_value, programmer_comments) values (727, 'Painted Steel', 'Steel (NEC)', null);
insert into ust_element_value_mapping (ust_element_mapping_id, organization_value, epa_value, programmer_comments) values (727, 'Painted Steel w/ Lining', 'Steel (NEC)', null);
insert into ust_element_value_mapping (ust_element_mapping_id, organization_value, epa_value, programmer_comments) values (727, 'Perma Tank', 'Other', 'Please verify.');
insert into ust_element_value_mapping (ust_element_mapping_id, organization_value, epa_value, programmer_comments) values (727, 'Polyethylene', 'Other', 'Please verify.');
insert into ust_element_value_mapping (ust_element_mapping_id, organization_value, epa_value, programmer_comments) values (727, 'Polypropylene', 'Other', 'Please verify.');
insert into ust_element_value_mapping (ust_element_mapping_id, organization_value, epa_value, programmer_comments) values (727, 'Second Contain', 'Other', 'Please verify.');
insert into ust_element_value_mapping (ust_element_mapping_id, organization_value, epa_value, programmer_comments) values (727, 'Skid', 'Other', 'Please verify.');
insert into ust_element_value_mapping (ust_element_mapping_id, organization_value, epa_value, programmer_comments) values (727, 'Stainless Steel', 'Other', 'Please verify.');
...
insert into ust_element_value_mapping (ust_element_mapping_id, organization_value, epa_value, programmer_comments) values (727, 'Steel/Horizontal', 'Steel (NEC)', null);
...
insert into ust_element_value_mapping (ust_element_mapping_id, organization_value, epa_value, programmer_comments) values (727, 'Steel/Vertical', 'Steel (NEC)', null);
insert into ust_element_value_mapping (ust_element_mapping_id, organization_value, epa_value, programmer_comments) values (727, 'Steeltank/Contain', 'Steel (NEC)', null);
insert into ust_element_value_mapping (ust_element_mapping_id, organization_value, epa_value, programmer_comments) values (727, 'STIP3', 'Other', 'Please verify.');
insert into ust_element_value_mapping (ust_element_mapping_id, organization_value, epa_value, programmer_comments) values (727, 'STIP3/Compart', 'Other', 'Please verify.');
insert into ust_element_value_mapping (ust_element_mapping_id, organization_value, epa_value, programmer_comments) values (727, 'Total Containment', 'Other', 'Please verify.');
insert into ust_element_value_mapping (ust_element_mapping_id, organization_value, epa_value, programmer_comments) values (727, 'Total Containment/Compart', 'Other', 'Please verify.');
...
case "TankPipingMaterial" when 'Fiberglass' then 'Yes' end piping_material_frp,
...
case "TankPipingMaterial" when 'Steel' then 'Yes' end piping_material_steel,
case "TankPipingMaterial" when 'Copper' then 'Yes' end piping_material_copper,
case when "TankPipingMaterial"  like '%Flex%' then 'Yes' end piping_material_flex,
case "TankPipingMaterial" when 'Not Applicable' then 'Yes' end piping_material_no_piping,
