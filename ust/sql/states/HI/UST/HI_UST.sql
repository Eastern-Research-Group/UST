 ...
 * Do a global replace in this script from 37 to the new ust_control_id.
 */
update ust_control
set comments = 'Excluding Tank Statuses of Not installed and To be installed'
...
values (37,'ust_facility','facility_id','tblFacility','FacilityID',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic)
values (37,'ust_facility','facility_name','tblFacility','Facility Name',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic, organization_join_table, organization_join_column, organization_join_fk) 
values (37,'ust_facility','owner_type_id','tblContactAffiliation','Owner Type:',null,null, 'tblFacility', 'FacilityID', null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_facility','facility_type1','tblFacility','Facility Description',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_facility','facility_address1','tblFacility','Street Address',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic, organization_join_table, organization_join_column, organization_join_fk) 
values (37,'ust_facility','facility_city','tlkpZIP','City',null,null,'tblFacility', 'ZIP Linkage', 'ZIP ID');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic, organization_join_table, organization_join_column, organization_join_fk) 
values (37,'ust_facility','facility_county','tlkpZIP','County',null,null, 'tblFacility', 'ZIP Linkage', 'ZIP ID');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic, organization_join_table, organization_join_column, organization_join_fk) 
values (37,'ust_facility','facility_zip_code','tlkpZIP','ZIP Code',null,null, 'tblFacility', 'ZIP Linkage', 'ZIP ID');
...
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic, organization_join_table, organization_join_column, organization_join_fk) 
values (37,'ust_facility','facility_state','tlkpZIP','State',null,null, 'tblFacility', 'ZIP Linkage', 'ZIP ID');
...
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_facility','facility_latitude','tblFacility','LatitudeMeasure',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_facility','facility_longitude','tblFacility','LongitudeMeasure',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_facility','coordinate_source_id','tblFacility','HorizontalCollectionMethodName',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic, organization_join_table, organization_join_column, organization_join_fk)
values (37,'ust_facility','facility_owner_company_name','tblContactOrganization','OrganizationFormalName',null,null, 'tblFacility', 'OwnerID', 'OwnerId');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic, organization_join_table, organization_join_column, organization_join_fk)
values (37,'ust_facility','financial_responsibility_obtained','tblFacilityFR','FRType',null,'WHEN x."FRType" = ''Not Listed''::text THEN ''Unknown''::text
            WHEN x."FRType" = ''Exempt, Stage Agency''::text THEN ''No''::text
            WHEN x."FRType" = ''/''::text THEN NULL::text
            WHEN x."FRType" IS NULL THEN NULL::text
            ELSE ''Yes''::text', 'tblFacility', 'FacilityID', null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic, organization_join_table, organization_join_column, organization_join_fk)
values (37,'ust_facility','financial_responsibility_commercial_insurance','tblFacilityFR','FRType',null,'WHEN x."FRType" = ''commercial insurance''::text THEN ''Yes''::text
            WHEN x."FRType" = ''Insurance''::text THEN ''Yes''::text
            WHEN x."FRType" = ''nsurance''::text THEN ''Yes''::text
            ELSE NULL::text', 'tblFacility', 'FacilityID', null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic, organization_join_table, organization_join_column, organization_join_fk)
values (37,'ust_facility','financial_responsibility_guarantee','tblFacilityFR','FRType',null,'WHEN x."FRType" = ''Guarantee''::text THEN ''Yes''::text
            ELSE NULL::text', 'tblFacility', 'FacilityID', null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic, organization_join_table, organization_join_column, organization_join_fk)
values (37,'ust_facility','financial_responsibility_letter_of_credit','tblFacilityFR','FRType',null,'WHEN x."FRType" = ''Letter of Credit''::text THEN ''Yes''::text
            ELSE NULL::text', 'tblFacility', 'FacilityID', null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic, organization_join_table, organization_join_column, organization_join_fk) 
values (37,'ust_facility','financial_responsibility_local_government_financial_test','tblFacilityFR','FRType',null,'WHEN x."FRType" ~~ ''Local Gov_t Bond Rating''::text THEN ''Yes''::text
            ELSE NULL::text', 'tblFacility', 'FacilityID', null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic, organization_join_table, organization_join_column, organization_join_fk) 
values (37,'ust_facility','financial_responsibility_risk_retention_group','tblFacilityFR','FRType',null,'WHEN x."FRType" = ''Risk Retention Group''::text THEN ''Yes''::text
            ELSE NULL::text', 'tblFacility', 'FacilityID', null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic, organization_join_table, organization_join_column, organization_join_fk)
values (37,'ust_facility','financial_responsibility_self_insurance_financial_test','tblFacilityFR','FRType',null,'WHEN x."FRType" = ''Self Insured''::text THEN ''Yes''::text
            ELSE NULL::text', 'tblFacility', 'FacilityID', null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic, organization_join_table, organization_join_column, organization_join_fk)
values (37,'ust_facility','financial_responsibility_state_fund','tblFacilityFR','FRType',null,'WHEN x."FRType" = ''State Fund''::text THEN ''Yes''::text
            ELSE NULL::text', 'tblFacility', 'FacilityID', null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic, organization_join_table, organization_join_column, organization_join_fk)
values (37,'ust_facility','financial_responsibility_surety_bond','tblFacilityFR','FRType',null,'WHEN x."FRType" = ''Surety Bond''::text THEN ''Yes''::text
            ELSE NULL::text', 'tblFacility', 'FacilityID', null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic, organization_join_table, organization_join_column, organization_join_fk)
values (37,'ust_facility','financial_responsibility_trust_fund','tblFacilityFR','FRType',null,'WHEN x."FRType" = ''Trust Fund''::text THEN ''Yes''::text
            ELSE NULL::text', 'tblFacility', 'FacilityID', null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic, organization_join_table, organization_join_column, organization_join_fk)
values (37,'ust_facility','financial_responsibility_other_method','tblFacilityFR','FRType',null,'WHEN x."FRType" = ''Other''::text THEN ''Yes''::text
            ELSE NULL::text', 'tblFacility', 'FacilityID', null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic, organization_join_table, organization_join_column, organization_join_fk) 
values (37,'ust_facility','ust_reported_release','tblLUSTSite','AltEventId',null,'when x."AltEventId" is not null then ''Yes''', 'tblFacility', 'FacilityID', 'FacilityId');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic, organization_join_table, organization_join_column, organization_join_fk) 
values (37,'ust_facility','associated_ust_release_id','tblLUSTSite','AltEventId',null,null, 'tblFacility', 'FacilityID', 'FacilityId');
...
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_tank','facility_id','tblTank','FacilityID',null,null);
...
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_tank','tank_id','tblTank','TankID',null,null);
...
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_tank','tank_name','tblTank','AltTankID',null,null);
...
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_tank','tank_status_id','tblTank','TankStatusDesc',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_tank','federally_regulated','tblTank','Exempt',null,'when x."Exempt" = true then ''No'' when x."Exempt" = false then ''Yes'' ');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_tank','emergency_generator','tblTank','EmergGenSoleUse',null,'when x."EmergGenSoleUse" = true then ''Yes'' when x."EmergGenSoleUse" = false then ''No''');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_tank','multiple_tanks','tblTank','TankID',null,'left join (select FacilityID, count(TankID) as multi_tank_count from hi_ust.tblTank group by FacilityID) mt on x.FacilityID = mt.FacilityID;
when multi_tank_count > 1 then Yes else No');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_tank','tank_closure_date','tblTank','DateClosed',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_tank','tank_installation_date','tblTank','InstalledDate',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_tank','compartmentalized_ust','tblTank','Compartment',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_tank','tank_material_description_id','tblTank','TankMatDesc',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_tank','tank_corrosion_protection_sacrificial_anode','tblTank','TankCorrosionProtectionSacrificialAnodes',null,'when TankCorrosionProtectionSacrificialAnodes = false then No, when TankCorrosionProtectionSacrificialAnodes = true then Yes');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_tank','tank_corrosion_protection_impressed_current','tblTank','TankCorrosionProtectionImpressedCurrent',null,'when TankCorrosionProtectionImpressedCurrent = false then No, when TankCorrosionProtectionImpressedCurrent = true then Yes');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_tank','tank_corrosion_protection_cathodic_not_required','tblTank','TankCorrosionProtectionNonCorrodible',null,'when TankCorrosionProtectionNonCorrodible = false then No, when TankCorrosionProtectionNonCorrodible = true then Yes');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_tank','tank_corrosion_protection_interior_lining','tblTank','TankCorrosionProtectionInteriorLining',null,'when TankCorrosionProtectionInteriorLining = false then No, when TankCorrosionProtectionInteriorLining = true then Yes');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_tank','tank_secondary_containment_id','tblTank','TankModsDesc',null,null);

--ust_tank_substance: This table is OPTIONAL (but most states will have data)
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_tank_substance','facility_id','tblTank','FacilityID',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_tank_substance','tank_id','tblTank','TankID',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_tank_substance','tank_name','tblTank','AltTankID',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_tank_substance','substance_id','tblTank','SubstanceDesc',null,null);
...
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_compartment','facility_id','tblTank','FacilityID',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_compartment','tank_id','tblTank','TankID',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_compartment','tank_name','tblTank','AltTankID',null,null);
...
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_compartment','compartment_status_id','tblTank','TankStatusDesc',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_compartment','compartment_capacity_gallons','tblTank','TankCapacity',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_compartment','overfill_prevention_ball_float_valve','tblTank','OverfillBallFloat',null,'when OverfillBallFloat = false then No, when OverfillBallFloat = true then Yes');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_compartment','overfill_prevention_flow_shutoff_device','tblTank','OverfillFlapper',null,'when OverfillFlapper = false then No, when OverfillFlapper = true then Yes');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_compartment','overfill_prevention_high_level_alarm','tblTank','OverfillAlarm',null,'when OverfillAlarm = false then No, when OverfillAlarm = true then Yes');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_compartment','spill_bucket_installed','tblTank','SpillInstalled',null,'when SpillInstalled = false then No, when SpillInstalled = true then Yes');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_compartment','tank_interstitial_monitoring','tblTank','TankInterstitialDblWalled',null,'when TankInterstitialDblWalled = false then No, when TankInterstitialDblWalled = true then Yes');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_compartment','tank_automatic_tank_gauging_release_detection','tblTank','TankATG',null,'whenTankATG = false then No, when TankATG = true then Yes');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_compartment','tank_manual_tank_gauging','tblTank','TankManualGauge',null,'when TankManualGauge = false then No, when TankManualGauge = true then Yes');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_compartment','tank_statistical_inventory_reconciliation','tblTank','TankSIR',null,'when TankSIR = false then No, when TankSIR = true then Yes');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_compartment','tank_tightness_testing','tblTank','TankTightness',null,'when TankTightness = false then No, when TankTightness = true then Yes');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_compartment','tank_inventory_control','tblTank','TankInventoryControl',null,'when TankInventoryControl = false then No, when TankInventoryControl = true then Yes');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_compartment','tank_groundwater_monitoring','tblTank','TankGWMonitor',null,'when TankGWMonitor = false then No, when TankGWMonitor = true then Yes');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_compartment','tank_vapor_monitoring','tblTank','TankVaporMonitor',null,'when TankVaporMonitor = false then No, when TankVaporMonitor = true then Yes');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_compartment','tank_other_release_detection','tblTank','TankLDOther',null,'when TankLDOther = false then No, when TankLDOther = true then Yes');


--ust_piping: This table is OPTIONAL; do not map if there is no piping data in the source data
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_piping','facility_id','tblTank','FacilityID',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_piping','tank_id','tblTank','TankID',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_piping','tank_name','tblTank','AltTankID',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_piping','piping_style_id','tblTank','PipeTypeDesc',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_piping','safe_suction','tblTank','PipeTypeDesc',null,'when PipeTypeDesc = Safe Suction then Yes');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_piping','american_suction','tblTank','PipeTypeDesc',null,'when PipeTypeDesc = U.S. Suction then Yes');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_piping','piping_wall_type_id','tblTank','PipeModDesc',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_piping','piping_material_frp','tblTank','PipeMatDesc',null,'WHEN x."PipeMatDesc" = ''Fiberglass Reinforced Plastic''::text THEN ''Yes''::text
            WHEN x."PipeMatDesc" IS NULL THEN NULL::text');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_piping','piping_material_gal_steel','tblTank','PipeMatDesc',null,'WHEN x."PipeMatDesc" = ''GALVANIZED STEEL''::text THEN ''Yes''::text
            WHEN x."PipeMatDesc" = ''Galvanized Steel''::text THEN ''Yes''::text
            WHEN x."PipeMatDesc" IS NULL THEN NULL::text');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_piping','piping_material_steel','tblTank','PipeMatDesc',null,'WHEN x."PipeMatDesc" = ''BARE STEEL''::text THEN ''Yes''::text
            WHEN x."PipeMatDesc" = ''Bare Steel''::text THEN ''Yes''::text
            WHEN x."PipeMatDesc" IS NULL THEN NULL::text');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_piping','piping_material_copper','tblTank','PipeMatDesc',null,'WHEN x."PipeMatDesc" = ''Copper''::text THEN ''Yes''::text
            WHEN x."PipeMatDesc" IS NULL THEN NULL::text');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_piping','piping_material_flex','tblTank','PipeMatDesc',null,'WHEN x."PipeMatDesc" = ''Flexible Plastic''::text THEN ''Yes''::text
            WHEN x."PipeMatDesc" IS NULL THEN NULL::text');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_piping','piping_material_no_piping','tblTank','PipeMatDesc',null,'WHEN x."PipeMatDesc" = ''No Piping''::text THEN ''Yes''::text
            WHEN x."PipeMatDesc" IS NULL THEN NULL::text');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_piping','piping_material_other','tblTank','PipeMatDesc',null,'WHEN x."PipeMatDesc" = ''Other''::text THEN ''Yes''::text
            WHEN x."PipeMatDesc" IS NULL THEN NULL::text');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_piping','piping_material_unknown','tblTank','PipeMatDesc',null,'WHEN x."PipeMatDesc" = ''Unknown''::text THEN ''Yes''::text
            WHEN x."PipeMatDesc" = ''UNKNOWN''::text THEN ''Yes''::text
            WHEN x."PipeMatDesc" IS NULL THEN NULL::text');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_piping','piping_corrosion_protection_sacrificial_anode','tblTank','PipeCorrosionProtectionSacrificialAnodes',null,'when PipeCorrosionProtectionSacrificialAnodes = false then No, when PipeCorrosionProtectionSacrificialAnodes = true then Yes');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_piping','piping_corrosion_protection_impressed_current','tblTank','PipeCorrosionProtectionImpressedCurrent',null,'when PipeCorrosionProtectionImpressedCurrent = false then No, when PipeCorrosionProtectionImpressedCurrent = true then Yes');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_piping','piping_corrosion_protection_cathodic_not_required','tblTank','PipeCorrosionProtectionNonCorrodible',null,'when PipeCorrosionProtectionNonCorrodible = false then No, when PipeCorrosionProtectionNonCorrodible = true then Yes');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_piping','piping_line_leak_detector','tblTank','PipeAutoLineLeakDetection',null,'when PipeAutoLineLeakDetection = false then No, when PipeAutoLineLeakDetection = true then Yes');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_piping','piping_groundwater_monitoring','tblTank','PipeGWMonitoring',null,'when PipeGWMonitoring = false then No, when PipeGWMonitoring = true then Yes');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_piping','piping_vapor_monitoring','tblTank','PipeVaporMonitoring',null,'when PipeVaporMonitoring = false then No, when PipeVaporMonitoring = true then Yes');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_piping','piping_interstitial_monitoring','tblTank','PipeInterstitialDblWalled','Please Verify','when PipeInterstitialDblWalled = false then No, when PipeInterstitialDblWalled = true then Yes');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_piping','piping_statistical_inventory_reconciliation','tblTank','PipeSIR',null,'when PipeSIR = false then No, when PipeSIR = true then Yes');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_piping','piping_release_detection_other','tblTank','PipeLDOther',null,'when PipeLDOther = false then No, when PipeLDOther = true then Yes');
...
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_facility_dispenser','facility_id','ORG_TAB_NAME','ORG_COL_NAME',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_facility_dispenser','dispenser_id','ORG_TAB_NAME','ORG_COL_NAME',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_facility_dispenser','dispenser_udc','ORG_TAB_NAME','ORG_COL_NAME',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (37,'ust_facility_dispenser','dispenser_udc_wall_type','ORG_TAB_NAME','ORG_COL_NAME',null,null);
...
ust_or_release = 'ust' 			# valid values are 'ust' or 'release'
control_id = 37                 # Enter an integer that is the ust_control_id or release_control_id
...
select epa_column_name from 
	...
	where ust_control_id = 37 and mapping_complete = 'N'
...
ust_or_release = 'ust' 			 # Valid values are 'ust' or 'release' 
control_id = 37                  # Enter an integer that is the ust_control_id
...
where ust_control_id = 37 and organization_table_name like 'erg%'
order by sort_order;
...
select comments from public.ust_control where ust_control_id = 37;
