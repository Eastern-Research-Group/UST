...
--View definition for dc_ust.v_ust_tank:
     ...
     create view dc_ust.v_ust_tank as       
...
drop view dc_ust.v_ust_tank;


select substance, count(*)
from dc_ust.v_ust_tank_substance a join substances b on a.substance_id = b.substance_id
group by substance order by 1;
...
--View definition for dc_ust.v_ust_facility_dispenser:
 SELECT DISTINCT (x."FacilityID")::text AS facility_id,
