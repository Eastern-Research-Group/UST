 ...
 * Do a global replace in this script from 32 to the new ust_control_id.
 */
------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
values (32,'ust_facility','facility_id','tblustsite','ustID',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic)
values (32,'ust_facility','facility_name','tblustsite','ustName',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_facility','owner_type_id','tblustsite','ownerTypeID',null,'case when ownertypeid in (1, 4, 5) then ''Local Government'' when ownertypeid = 2 then ''Federal Government - Non Military'' when ownertypeid = 3 then ''Tribal Governernment'' when ownertypeid = 6 then ''Private'' when ownertypeid = 7 then ''State Government - Non Military'' when ownertypeid in (8, 9) then ''Other'' ELSE '''' END AS  OwnerType,');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_facility','facility_address1','tbllocation','loc1Address',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_facility','facility_address2','tbllocation','loc2Address',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_facility','facility_city','tbllocation','CityID',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_facility','facility_county','tlkcounty','CountyName',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_facility','facility_zip_code','tbllocation','locZip',null,null);
...
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_facility','facility_state','tbllocation','locStateCD',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_facility','facility_latitude','tbllocation','latitude',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_facility','facility_longitude','tbllocation','longitude',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_facility','coordinate_source_id','tbllocation','colMthID',null,'CASE WHEN ColMthID in (6, 3, 1, 7, 5) THEN ''Geocoded address'' WHEN ColMthID in (16, 15, 14, 12) THEN ''GPS'' WHEN ColMthID in (30, 19, 18) THEN ''Map interpolation'' WHEN ColMthID in (8, 26) THEN ''Other'' WHEN ColMthID in (35, 23) THEN ''PLSS'' ELSE '''' END as FacilityCoordinateSource,');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_facility','facility_owner_company_name','tblorganization','orgName',null,'case when tblaffiliation.affTypeID in (1,25) then orgName');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_facility','facility_operator_company_name','tblorganization','orgName',null,'case when tblaffiliation.affTypeID in (4,23,24) then orgName');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_facility','financial_responsibility_obtained','tblustsite','financialCode',null,'CASE WHEN u.financialCode is not null THEN ''Yes'' ELSE ''No'' END as FinancialResponsibilityObtained,');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_facility','financial_responsibility_bond_rating_test','tblustsite','financialCode',null,'CASE WHEN u.financialCode = 09 THEN ''Yes'' ELSE ''No'' END as FinancialResponsiblityBondRatingTest,');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_facility','financial_responsibility_commercial_insurance','tblustsite','financialCode',null,'CASE WHEN u.financialCode in (15, 02) THEN ''Yes'' ELSE ''No'' END as FinancialResponsiblityCommercialInsurance,');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_facility','financial_responsibility_guarantee','tblustsite','financialCode',null,'CASE WHEN u.financialCode = 03 THEN ''Yes'' ELSE ''No'' END as FinancialResponsiblityGuarantee,');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_facility','financial_responsibility_letter_of_credit','tblustsite','financialCode',null,'CASE WHEN u.financialCode = 05 THEN ''Yes'' ELSE ''No'' END as FinancialResponsiblityLetterOfCredit,');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_facility','financial_responsibility_local_government_financial_test','tblustsite','financialCode',null,'CASE WHEN u.financialCode = 10 THEN ''Yes'' ELSE ''No'' END as FinancialResponsiblityLocalGovernmentFinancialTest,');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_facility','financial_responsibility_self_insurance_financial_test','tblustsite','financialCode',null,'CASE WHEN u.financialCode = 01 THEN ''Yes'' ELSE ''No'' END as FinancialResponsiblitySelfInsuranceFinancialTest,');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_facility','financial_responsibility_state_fund','tblustsite','financialCode',null,'CASE WHEN u.financialCode = 06 THEN ''Yes'' ELSE ''No'' END as FinancialResponsiblityStateFund,');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_facility','financial_responsibility_surety_bond','tblustsite','financialCode',null,'CASE WHEN u.financialCode = 04 THEN ''Yes'' ELSE ''No'' END as FinancialResponsiblitySuretyBond,');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_facility','financial_responsibility_trust_fund','tblustsite','financialCode',null,'CASE WHEN u.financialCode = 08 THEN ''Yes'' ELSE ''No'' END as FinancialResponsiblityTrustBond,');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_facility','financial_responsibility_other_method','tblustsite','financialCode',null,'CASE WHEN u.financialCode not in (09, 15, 02, 03, 05, 09, 10, 01, 06, 04, 08) THEN fcDescription ELSE '''' END as FinancialResponsiblityOtherMethod,');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_facility','ust_reported_release','tbllustsite','lustID',null,'CASE WHEN lust.ustID is not null THEN ''Yes'' ELSE ''No'' END as USTReportedRelease,
left join (select ustid, max(startdate) as maxstartdate from ustlust.tblLustSite group by ustid) lust on lust.ustID = u.ustID');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_facility','associated_ust_release_id','tblustsite','lustID',null,'left join (select ustid, max(startdate) as maxstartdate from ustlust.tblLustSite group by ustid) lust on lust.ustID = u.ustID');
...
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_tank','facility_id','tblustsite','ustID',null,null);
...
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_tank','tank_id','tbltank','tankID',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_tank','tank_location_id','','Underground(entirely buried)',null,null);
...
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_tank','tank_status_id','tlkCompStatus','compStatusID',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_tank','federally_regulated','tlkstatus','statusDescription',null,'CASE WHEN uststatus.statusDescription like ''non-regulated%'' or uststatus.statusdescription like ''%exempt%'' or uststatus.statusdescription like ''%ust distrib%'' or uststatus.statusdescription like ''%deleted%'' or uststatus.statusdescription like ''%1974%'' THEN ''No'' WHEN uststatus.statusdescription = ''Other'' THEN ''Unknown'' ELSE ''Yes'' END as FederallyRegulated, ');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_tank','emergency_generator','tlkstatus','statusDescription',null,'CASE WHEN uststatus.statusDescription like ''Emergency power generator tank%'' THEN ''Yes''  ELSE ''No'' END as EmergencyGenerator, ');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_tank','multiple_tanks','tblTank','countoftanks',null,'left join (select ustid, count(tankid) as countoftanks from ustlust.tblTank group by ustid) tankcount on u.ustid = tankcount.ustID
CASE WHEN countoftanks > 1 THEN ''Yes'' ELSE ''No'' END as MultipleTanks,');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_tank','tank_closure_date','tbltankdates','tankdate',null,'left join (select tankid, min(tankdate) as tankdate from ustlust.tblTankDates where dateTypeID in (7,8) group by tankID) tankclosuredate on tankclosuredate.tankid = t.tankid');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_tank','tank_installation_date','tbltankdates','tankdate',null,'left join (select tankid, tankdate from ustlust.tblTankDates where dateTypeID in (4)) tankinstalldate on tankinstalldate.tankid = t.tankid');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_tank','compartmentalized_ust','tbltankcompartment','tankCompartmentID',null,'left join (select tankid, count(tankcompartmentid) countofcomps from ustlust.tblTankCompartment group by tankid) tc on tc.tankid = t.tankID
CASE WHEN countofcomps > 1 THEN ''Yes'' ELSE ''No'' END as CompartmentalizedUST,');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_tank','number_of_compartments','tbltankcompartment','tankCompartmentID',null,'left join (select tankid, count(tankcompartmentid) countofcomps from ustlust.tblTankCompartment group by tankid) tc on tc.tankid = t.tankID');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_tank','tank_material_description_id','tlkMaterialConstruction','materialConDescription',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_tank','tank_corrosion_protection_impressed_current','treltanktoexternalprotection','externalProtectionID',null,'Case when externalProtectionID = 4 then Yes, else null');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_tank','tank_corrosion_protection_interior_lining','treltanktoexternalprotection','externalProtectionID',null,'Case when externalProtectionID in (5,6,7,8) then Yes, else null');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_tank','tank_corrosion_protection_other','treltanktoexternalprotection','externalProtectionID',null,'case when externalProtectionID in (9,10) then Yes, else null');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_tank','tank_corrosion_protection_unknown','treltanktoexternalprotection','externalProtectionID',null,'case when externalProtectionID not in (1,4,5,6,7,8,9,10) then Yes, else null');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_tank','cert_of_installation_id','treltanktoinstallation','installationID',null,'CASE installationID WHEN 1 THEN ''Installer certified by tank and piping manufacturers'' WHEN 5 THEN ''Installer certified or licensed by the implementing agency'' WHEN 2 THEN ''Installation inspected by a registered engineer'' WHEN 6 THEN ''Installation inspected and approved by implementing agency'' WHEN 3 THEN ''Manufacturer''s installation checklists have been completed'' WHEN 4 THEN ''Other method - specify'' WHEN 7 THEN ''Other method - specify'' ELSE '''' END as CertOfInstallation,');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_tank','cert_of_installation_other','treltanktoinstallation','installationID',null,'CASE installationID WHEN 4 THEN ''Tank and Piping Tested for Leaks During and After Installation'' WHEN 7 THEN ''Unknown'' ELSE '''' END as CertOfInstallationOther');

--ust_tank_substance: This table is OPTIONAL (but most states will have data)
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_tank_substance','facility_id','tblustsite','ustID',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_tank_substance','tank_id','tbltank','tankID',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_tank_substance','substance_id','tlkcompcontent','contentDescription',null,null);
...
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_compartment','facility_id','tblustsite','ustID',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_compartment','tank_id','tbltank','tankID',null,null);
...
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_compartment','compartment_id','tbltankcompartment','tankCompartmentID',null,null);
...
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_compartment','compartment_status_id','tlkCompStatus','compStatusID',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_compartment','compartment_capacity_gallons','tbltankcompartment','capacity',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_compartment','overfill_prevention_flow_shutoff_device','trelcomptospilloverfill','spillOverfillID',null,'CASE overfill.spillOverfillID WHEN 2 THEN ''Yes'' ELSE ''No'' END as OverfillPreventionFlowShutoffDevice,');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_compartment','overfill_prevention_high_level_alarm','trelcomptospilloverfill','spillOverfillID',null,'CASE overfill.spillOverfillID WHEN 3 THEN ''Yes'' ELSE ''No'' END as OverfillPreventionHighLevelAlarm,');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_compartment','overfill_prevention_other','trelcomptospilloverfill','spillOverfillID',null,'CASE WHEN overfill.spillOverfillID not in (2,3) and overfill.spillOverfillID is not null THEN ''Yes'' ELSE ''No'' END as OverfillPreventionOther,');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_compartment','spill_bucket_installed','tbltankcompartment','catchmentBasin',null,'CASE WHEN catchmentBasin = 1 or catchmentBasinSize > 0 THEN ''Yes'' WHEN catchmentBasinSize = 0 THEN ''No'' ELSE ''Unknown'' END as SpillBucketInstalled,');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_compartment','spill_prevention_not_required','tbltankcompartment','spillProtection',null,'CASE spillProtection WHEN  1 THEN ''No'' WHEN 0 THEN ''Yes'' ELSE '''' END as SpillPreventionNotRequired,');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_compartment','spill_bucket_wall_type_id','tbltankcompartment','Wall',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_compartment','tank_interstitial_monitoring','tbltankcompartment','InterstitialMonitoring',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_compartment','automatic_tank_gauging_continuous_leak_detection','trelcomptoleakprotection','leakProtectionID',null,'Case when leakProtectionID = 11 then ''Yes'' ');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_compartment','tank_manual_tank_gauging','trelcomptoleakprotection','leakProtectionID',null,'Case when leakProtectionID = 9 then ''Yes'' ');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_compartment','tank_statistical_inventory_reconciliation','trelcomptoleakprotection','leakProtectionID',null,'Case when leakProtectionID = 8 then ''Yes'' ');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_compartment','tank_tightness_testing','trelcomptoleakprotection','leakProtectionID',null,'Case when leakProtectionID = 7 then ''Yes'' ');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_compartment','tank_inventory_control','trelcomptoleakprotection','leakProtectionID',null,'Case when leakProtectionID = 12 then ''Yes'' ');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_compartment','tank_groundwater_monitoring','trelcomptoleakprotection','leakProtectionID',null,'Case when leakProtectionID = 2 then ''Yes'' ');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_compartment','tank_vapor_monitoring','trelcomptoleakprotection','leakProtectionID',null,'Case when leakProtectionID = 1 then ''Yes'' ');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_compartment','tank_other_release_detection','trelcomptoleakprotection','leakProtectionID',null,'Case when leakProtectionID not in (1,2,12,7,8,9,11) then ''Yes'' ');
...
values (32,'ust_compartment_substance','facility_id','tblustsite','ustID',null,null);
insert into ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_compartment_substance','tank_id','tbltank','tankID',null,null);
insert into ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_compartment_substance','compartment_id','tbltankcompartment','tankCompartmentID',null,null);
...
insert into ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_compartment_substance','substance_id','tlkcompcontent','contentDescription',null,null);

--ust_piping: This table is OPTIONAL; do not map if there is no piping data in the source data
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_piping','facility_id','tblustsite','ustID',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_piping','tank_id','tbltank','tankID',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_piping','compartment_id','tbltankcompartment','tankCompartmentID',null,null);
...
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_piping','piping_id','tblpipe','pipeID',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_piping','piping_style_id','tblpipe','pipeTypeID',null,'CASE WHEN pipetypeid in (2,3) THEN ''Suction'' WHEN pipeTypeID = 1 THEN ''Pressure'' ELSE '''' END as PipingStyle,');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_piping','safe_suction','tblpipe','pipeTypeID',null,'CASE WHEN pipetypeid = 3 THEN ''Yes'' ELSE '''' END as SafeSuction,');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_piping','american_suction','tblpipe','pipeTypeID',null,'CASE WHEN pipetypeid = 2 THEN ''Yes'' ELSE '''' END as AmericanSuction,');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_piping','piping_material_frp','tblpipe','pipingConstID',null,'CASE WHEN pipingConstID = 4 THEN ''Yes'' ELSE '''' END as PipingMaterialFRP,');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_piping','piping_material_gal_steel','tblpipe','pipingConstID',null,'CASE WHEN pipingConstID = 3 THEN ''Yes'' ELSE '''' END as PipingMaterialGalSteel,');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_piping','piping_material_steel','tblpipe','pipingConstID',null,'CASE WHEN pipingConstID = 1 THEN ''Yes'' ELSE '''' END as PipingMaterialSteel,');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_piping','piping_material_flex','tblpipe','pipingConstID',null,'CASE WHEN pipingConstID = 11 THEN ''Yes'' ELSE '''' END as PipingMaterialFlex,');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_piping','piping_material_no_piping','tblpipe','pipingConstID',null,'CASE WHEN p.pipeID is null THEN ''Yes'' ELSE ''No'' END as PipingMaterialNoPiping,');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_piping','piping_material_other','tblpipe','pipingConstID',null,'CASE WHEN pipingConstID not in (1,3,4,11) THEN ''Yes'' ELSE '''' END as PipingMaterialOther,');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_piping','piping_line_leak_detector','trelpipetoleakdetection','pipeLeakDetectionID',null,'Case when pipeLeakDetectionID in (1,2) then ''Yes'' ');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_piping','piping_groundwater_monitoring','trelpipetoleakdetection','pipeLeakDetectionID',null,'Case when pipeLeakDetectionID = 9 then ''Yes'' ');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_piping','piping_vapor_monitoring','trelpipetoleakdetection','pipeLeakDetectionID',null,'Case when pipeLeakDetectionID = 8 then ''Yes'' ');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_piping','piping_statistical_inventory_reconciliation','trelpipetoleakdetection','pipeLeakDetectionID',null,'Case when pipeLeakDetectionID = 4 then ''Yes'' ');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_piping','piping_release_detection_other','trelpipetoleakdetection','pipeLeakDetectionID',null,'Case when pipeLeakDetectionID not in (1,2,4,9,8) then ''Yes'' ');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_piping','pipe_tank_top_sump','tblpipe','TransitionSumpPresent',null,null);
...
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_facility_dispenser','facility_id','tblustiste','ustID',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_facility_dispenser','dispenser_id','tbldispensers','DispenserID',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_facility_dispenser','dispenser_udc','tbldispensers','UDCPresent',null,'CASE UDCPresent WHEN 1 THEN ''Yes'' WHEN 0 THEN ''No'' ELSE '''' END as DispenserUDC,');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (32,'ust_facility_dispenser','dispenser_udc_wall_type','tbldispensers','DoubleWall',null,'CASE DoubleWall WHEN 1 THEN ''Double'' WHEN 0 THEN ''Single'' ELSE '''' END as DispenserUDCWallType');
...
ust_or_release = 'ust' 			# valid values are 'ust' or 'release'
control_id = 32                 # Enter an integer that is the ust_control_id or release_control_id
...
select epa_column_name from 
	...
	where ust_control_id = 32 and mapping_complete = 'N'
...
ust_or_release = 'ust' 			 # Valid values are 'ust' or 'release' 
control_id = 32                  # Enter an integer that is the ust_control_id
...
where ust_control_id = 32 and organization_table_name like 'erg%'
order by sort_order;
...
select comments from public.ust_control where ust_control_id = 32;
