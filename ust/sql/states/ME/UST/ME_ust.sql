...
values ('ME', '2025/1/17', current_date, 'Three URLs: https://www.maine.gov/dep/ftp/tanks/tanks_owner_all_registered_tanks.txt
https://www.maine.gov/dep/maps-data/index.html
https://www.maine.gov/dep/ftp/hoss/
https://www.maine.gov/dep/maps-data/documents/hosscodesheet.pdf', 'Mapping done by ERG', 'N')
returning ust_control_id;

update ust_control
set organization_compartment_flag = 'Y'
where ust_control_id = 31;
 ...
 * Do a global replace in this script from 31 to the new ust_control_id.
 */
------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
values (31,'ust_facility','facility_id','tanks','REGISTRATION NUMBER',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic)
values (31,'ust_facility','facility_name','tanks','FACILITY NAME',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_facility','facility_type1','tanks','FACILITY USE CODE',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_facility','facility_address1','tanks','FACILITY STREET ADDRESS',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_facility','facility_address2','ORG_TAB_NAME','ORG_COL_NAME',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_facility','facility_city','tanks','FACILITY CITY',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_facility','facility_latitude','tanks','LATITUDE',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_facility','facility_longitude','tanks','LONGITUDE',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_facility','facility_owner_company_name','tanks','OWNER NAME',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_facility','facility_operator_company_name','tanks','OPERATOR NAME',null,null);
...
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_tank','facility_id','tanks','REGISTRATION NUMBER',null,null);
...
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_tank','tank_id','tanks','TANK NUMBER',null,null);
...
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_tank','tank_location_id','tanks','TANK ABOVE BELOW',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_tank','tank_status_id','tanks','TANK STATUS',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_tank','federally_regulated','tanks','FED REGULATED',null,'when FED REGULATED = Y then Yes, when FED REGULATED = N then No');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_tank','multiple_tanks','ORG_TAB_NAME','ORG_COL_NAME',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_tank','tank_closure_date','tanks','TANK STATUS DATE',null,'when TANK STATUS = REMOVED then TANK STATUS DATE, when TANK STATUS = ABANDONED_IN_PLACE then TANK STATUS DATE, else null');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_tank','tank_installation_date','tanks','DATE TANK INSTALLED',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_tank','compartmentalized_ust','ORG_TAB_NAME','ORG_COL_NAME',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_tank','number_of_compartments','ORG_TAB_NAME','ORG_COL_NAME',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_tank','tank_material_description_id','tanks','TANK MATERIAL LABEL',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_compartment','compartment_capacity_gallons','tanks','VOLUME IN GALLONS',null,null);


--ust_tank_substance: This table is OPTIONAL (but most states will have data)
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_tank_substance','facility_id','tanks','REGISTRATION NUMBER',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_tank_substance','tank_id','tanks','TANK NUMBER',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_tank_substance','substance_id','tanks','PRODUCT STORED',null,null);
...
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_compartment','facility_id','tanks','REGISTRATION NUMBER',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_compartment','tank_id','tanks','TANK NUMBER',null,null);
...
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_compartment','compartment_id','tanks','CHAMBER ID',null,null);
...
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_compartment','compartment_status_id','tanks','TANK STATUS LABEL',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_compartment','tank_automatic_tank_gauging_release_detection','tanks','TANK LEAK DETECTION','Please Verify','when TANK LEAK DETECTION = AUTOMATIC_TANK_GAUGE then Yes');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_compartment','automatic_tank_gauging_continuous_leak_detection','tanks','TANK LEAK DETECTION','Please Verify','when TANK LEAK DETECTION = AUTOMATIC_TANK_GAUGE then Yes');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_compartment','tank_statistical_inventory_reconciliation','tanks','TANK LEAK DETECTION','Please Verify','When TANK LEAK DETECTION = MONTHLY_SIR then Yes');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_compartment','tank_inventory_control','tanks','TANK LEAK DETECTION','Please Verify','When TANK LEAK DETECTION = SIA_INVENTORY_ANALYSIS then Yes');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_compartment','tank_groundwater_monitoring','tanks','TANK LEAK DETECTION','Please Verify','When TANK LEAK DETECTION = CONTINUOUS_GROUNDWATER_MON then Yes, when TANK LEAK DETECTION = MANUAL_GROUNDWATER_SAMPLE then Yes');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_compartment','tank_vapor_monitoring','tanks','TANK LEAK DETECTION','Please Verify','When TANK LEAK DETECTION = CONTINUOUS_VAPOR_MONITORING then Yes');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_compartment','tank_other_release_detection','tanks','TANK LEAK DETECTION','Please Verify','When TANK LEAK DETECTION in (AUTOMATIC_TANK_GAUGE, MONTHLY_SIR, SIA_INVENTORY_ANALYSIS, CONTINUOUS_GROUNDWATER_MON, CONTINUOUS_VAPOR_GAUGE, UNKNOWN, NONE) then No, else Yes');
-- inserts after peer review
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_compartment','spill_bucket_installed','tanks','OVERFILL PROTECTION','Please Verify','When OVERFILL PROTECTION = SPILL CONTAINMENT then Yes');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_compartment','overfill_prevention_high_level_alarm','tanks','OVERFILL PROTECTION','Please Verify','When OVERFILL PROTECTION in (VENT_BALL, VENT_WHISTLE) then Yes');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_compartment','overfill_prevention_unknown','tanks','OVERFILL PROTECTION','Please Verify','When OVERFILL PROTECTION = UNKNOWN then Yes');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_compartment','overfill_prevention_flow_shutoff_device','tanks','OVERFILL PROTECTION','Please Verify','When OVERFILL PROTECTION in (PRESSURE_DROP_TUBE, DROP_TUBE) then Yes');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_compartment','overfill_prevention_ball_float_valve','tanks','OVERFILL PROTECTION','Please Verify','When OVERFILL PROTECTION = LEVEL_GAUGE then Yes');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_compartment','overfill_prevention_other','tanks','OVERFILL PROTECTION','Please Verify','When OVERFILL PROTECTION in (ELECTRONIC, MECHANICAL, MECH_ELEC) then Yes');
...
values (31,'ust_compartment_substance','facility_id','tanks','REGISTRATION NUMBER',null,null);
insert into ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_compartment_substance','tank_id','tanks','TANK NUMBER',null,null);
insert into ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_compartment_substance','compartment_id','tanks','CHAMBER ID',null,null);
...
insert into ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_compartment_substance','substance_id','tanks','PRODUCT STORED',null,null);

--ust_piping: This table is OPTIONAL, do not map if there is no piping data in the source data
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_piping','facility_id','tanks','REGISTRATION NUMBER',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_piping','tank_id','tanks','TANK NUMBER',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_piping','compartment_id','tanks','CHAMBER ID',null,null);
...
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31, 'ust_piping', 'piping_id', 'erg_piping', 'piping_id', 'No piping id in state data', null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_piping','piping_style_id','tanks','CHAMBER_PUMP_TYPE_LABEL',null,null);
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_piping','piping_material_gal_steel','tanks','PIPE MATERIAL LABEL','Please Verify','When PIPE MATERIAL LABEL = GALVANIZED STEEL then Yes, else No');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_piping','piping_material_stainless_steel','tanks','PIPE MATERIAL LABEL','Please Verify','When PIPE MATERIAL LABEL = STAINLESS STEEL then Yes, else No');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_piping','piping_material_steel','tanks','PIPE MATERIAL LABEL','Please Verify','When PIPE MATERIAL LABEL in (CARBON STEEL, STEEL WITH CATHODIC PROTECTION, DOUBLE-WALLED CP STEEL, STEEL - BARE OR ASPHALT COATED, STEEL WITH SECONDARY CONTAINMENT, BLACK STEEL, STEEL - BARE WITH INTERNAL LINING) then Yes, else No');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_piping','piping_material_copper','tanks','PIPE MATERIAL LABEL','Please Verify','When PIPE MATERIAL LABEL in (COPPER, COPPER WITH SECONDARY CONTAINMENT) then Yes, else No');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_piping','piping_material_flex','tanks','PIPE MATERIAL LABEL','Please Verify','When PIPE MATERIAL LABEL = FLEXIBLE DOUBLE-WALLED PIPING then Yes, else No');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_piping','piping_material_no_piping','tanks','PIPE MATERIAL LABEL','Please Verify','When PIPE MATERIAL LABEL = NONE then Yes, else No');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_piping','piping_material_other','tanks','PIPE MATERIAL LABEL','Please Verify','When PIPE MATERIAL LABEL = OTHER then Yes, when PIPE MATERIAL LABEL not in (GALVANIZED STEEL, STAINLESS STEEL, CARBON STEEL, STEEL WITH CATHODIC PROTECTION, DOUBLE-WALLED CP STEEL, STEEL - BARE OR ASPHALT COATED, STEEL WITH SECONDARY CONTAINMENT, BLACK STEEL, STEEL - BARE WITH INTERNAL LINING, FLEXIBLE DOUBLE-WALLED PIPING, NONE) then no, else Yes');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_piping','piping_line_leak_detector','tanks','PIPE LEAK DETECTION','Please Verify','When PIPE LEAK DETECTION = INLINE_LEAK_DETECTOR then Yes, else No');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_piping','piping_vapor_monitoring','tanks','PIPE LEAK DETECTION','Please Verify','When PIPE LEAK DETECTION = CONTINUOUS_VAPOR_MONITORING then Yes, else No');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_piping','piping_statistical_inventory_reconciliation','tanks','PIPE LEAK DETECTION','Please Verify','When PIPE LEAK DETECTION = MONTHLY_SIR then Yes, else No');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_piping','piping_release_detection_other','tanks','PIPE LEAK DETECTION','Please Verify','When PIPE LEAK DETECTION not in (INLINE_LEAK_DETECTOR, CONTINUOUS_VAPOR_MONITORING, MONTHLY_SIR, NONE, UNKNOWN) then Yes, else No');
insert into public.ust_element_mapping (ust_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (31,'ust_piping','pipe_secondary_containment_other','tanks','PIPE LEAK DETECTION','Please Verify','When PIPE LEAK DETECTION in (SEC_CONT_CONTIN_ELEC_MON, SEC_CONT_MANUAL_MON, SECONDARY_CONTAINMENT) then Yes, else No');
...
select epa_column_name from 
	...
	where ust_control_id = 31 and mapping_complete = 'N'
...
ust_or_release = 'ust' 			 # Valid values are 'ust' or 'release' 
control_id = 31                  # Enter an integer that is the ust_control_id
...
where ust_control_id = 31 and organization_table_name like 'erg%'
order by sort_order;
...
select comments from public.ust_control where ust_control_id = 31;
