 ...
 *    repo at /ust/sql/states/XX/Releases/XX_releases.sql (create these folders if necessary)
 ...
 * Do a global replace in this script from 21 to the new release_control_id.
 */

insert into release_control (organization_id, date_received, date_processed, data_source, comments)
values ('ME', '2025-01-17', current_date, 'Three URLs: https://www.maine.gov/dep/ftp/tanks/tanks_owner_all_registered_tanks.txt¶https://www.maine.gov/dep/maps-data/index.html¶https://www.maine.gov/dep/ftp/hoss/¶https://www.maine.gov/dep/maps-data/documents/hosscodesheet.pdf', 'Mapping done by ERG')
returning release_control_id;
------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
where table_schema = lower('me_release') order by 1;
...
select "UST_REGISTERED_FLAG", count(*)
from me_release.report_tank_involved r
where "UST_TANK_SITE_NUMBER" is not null or r."INC_TANK_CODE" = 'U'
group by "UST_REGISTERED_FLAG";

update release_control 
set "comments" = concat("comments", '; excluding where INC_TANK_CODE = A (where tank is aboveground) from table report_tank_involved')
where release_control_id = 21;

select distinct "INC_LOCATION_VALUE" from me_release.spill_report
...
values (21,'ust_release','facility_id','report_tank_involved','UST_TANK_SITE_NUMBER',null,null);
insert into public.release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic)
values (21,'ust_release','tank_id_associated_with_release','report_tank_involved','UST_TANK_NUMBER',null,null);
...
insert into public.release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (21,'ust_release','release_id','spill_log','L.SPILL_NUMBER',null,'Need to combine with all other tables in order to get full data. spill_log has the most distinct values');
insert into public.release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (21,'ust_release','federally_reportable_release','report_tank_involved','UST_REGISTERED_FLAG',null,null);
insert into public.release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (21,'ust_release','site_name','report_contact','COMPANY',null,null);
insert into public.release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (21,'ust_release','site_address','report_contact','ADDRESS_LINE1',null,null);
insert into public.release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (21,'ust_release','site_address2','report_contact','ADDRESS_LINE2',null,null);
insert into public.release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (21,'ust_release','site_city','report_contact','CITY_TOWN',null,null);
insert into public.release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (21,'ust_release','zipcode','report_contact','POSTAL_CODE',null,null);
insert into public.release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (21,'ust_release','state','report_contact','STATE_PROVINCE',null,null);
...
insert into public.release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (21,'ust_release','facility_type_id','spill_report','INC_LOCATION_VALUE',null,null);
insert into public.release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (21,'ust_release','latitude','report_spill_point','LATITUDE',null,null);
insert into public.release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (21,'ust_release','longitude','report_spill_point','LONGITUDE',null,null);
...
insert into public.release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (21,'ust_release','release_status_id','ORG_TAB_NAME','ORG_COL_NAME',null,null);
insert into public.release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (21,'ust_release','reported_date','ORG_TAB_NAME','ORG_COL_NAME',null,null);
insert into public.release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (21,'ust_release','nfa_date','ORG_TAB_NAME','ORG_COL_NAME',null,null);
insert into public.release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (21,'ust_release','media_impacted_soil','ORG_TAB_NAME','ORG_COL_NAME',null,null);
insert into public.release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (21,'ust_release','media_impacted_groundwater','ORG_TAB_NAME','ORG_COL_NAME',null,null);
insert into public.release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (21,'ust_release','media_impacted_surface_water','ORG_TAB_NAME','ORG_COL_NAME',null,null);
insert into public.release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (21,'ust_release','release_discovered_id','ORG_TAB_NAME','ORG_COL_NAME',null,null);
insert into public.release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (21,'ust_release','closed_with_contamination','ORG_TAB_NAME','ORG_COL_NAME',null,null);
--NOTE: no_further_action_letter_url ONLY applies to tribal/TrUSTD data. DO NOT MAP for any other organizations. 
insert into public.release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (21,'ust_release','no_further_action_letter_url','ORG_TAB_NAME','ORG_COL_NAME',null,null);
insert into public.release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (21,'ust_release','military_dod_site','ORG_TAB_NAME','ORG_COL_NAME',null,null);
...
--and then replace ORG_TAB_NAME below with the view name and ORG_COL_NAME with the concatenated column name.)
insert into public.release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (21,'ust_release_substance','release_id','ORG_TAB_NAME','ORG_COL_NAME',null,null);
--NOTE: If you are populating this table, substance_id is a required field. 
insert into public.release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (21,'ust_release_substance','substance_id','ORG_TAB_NAME','ORG_COL_NAME',null,null);
insert into public.release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (21,'ust_release_substance','quantity_released','ORG_TAB_NAME','ORG_COL_NAME',null,null);
insert into public.release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (21,'ust_release_substance','unit','ORG_TAB_NAME','ORG_COL_NAME',null,null);
...
--and then replace ORG_TAB_NAME below with the view name and ORG_COL_NAME with the concatenated column name.)
insert into public.release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (21,'ust_release_source','release_id','ORG_TAB_NAME','ORG_COL_NAME',null,null);
--NOTE: If you are populating this table, source_id is a required field. 
insert into public.release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (21,'ust_release_source','source_id','ORG_TAB_NAME','ORG_COL_NAME',null,null);
...
--and then replace ORG_TAB_NAME below with the view name and ORG_COL_NAME with the concatenated column name.)
insert into public.release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (21,'ust_release_cause','release_id','ORG_TAB_NAME','ORG_COL_NAME',null,null);
--NOTE: If you are populating this table, cause_id is a required field. 
insert into public.release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (21,'ust_release_cause','cause_id','ORG_TAB_NAME','ORG_COL_NAME',null,null);
...
--and then replace ORG_TAB_NAME below with the view name and ORG_COL_NAME with the concatenated column name.)
insert into public.release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (21,'ust_release_corrective_action_strategy','release_id','ORG_TAB_NAME','ORG_COL_NAME',null,null);
--NOTE: If you are populating this table, corrective_action_strategy_id is a required field. 
insert into public.release_element_mapping (release_control_id, epa_table_name, epa_column_name, organization_table_name, organization_column_name, programmer_comments, query_logic) 
values (21,'ust_release_corrective_action_strategy','corrective_action_strategy_id','ORG_TAB_NAME','ORG_COL_NAME',null,null);
...
ust_or_release = 'release' 		# valid values are 'ust' or 'release'
control_id = 21                 # Enter an integer that is the ust_control_id or release_control_id
...
select epa_column_name from 
	...
	where release_control_id = 21 and mapping_complete = 'N'
...
ust_or_release = 'release' 		 # Valid values are 'ust' or 'release' 
control_id = 21                  # Enter an integer that is the release_control_id
...
where release_control_id = 21 and organization_table_name like 'erg%'
order by sort_order;
...
select comments from public.release_control where release_control_id = 21;
