...
select * from public.facility_types  where lower(facility_type) like '%gov%';
/*
Map interpolation
GPS
PLSS
...
set programmer_comments=null,epa_value = 'State/local government'
where release_element_mapping_id = 310 and organization_value in ( 'LOC','STA');

select * from release_element_value_mapping where release_element_mapping_id = 310;


update release_element_value_mapping
set epa_Comments = 'Agree with other but are there any releases at proposed facilities?  ',
programmer_comments = 'Yes, there are 2 facilities flagged as proposed with releases in the state data. They both have a closed status and their start date was back 20+ years ago.'
where organization_value = 'PRO' and release_element_mapping_id = 310;



select * from release_element_value_mapping where release_element_mapping_id = 310 and organization_value = 'CHU'; 

update release_element_value_mapping 
set epa_value = 'Other',programmer_comments=null,epa_comments='For mapping purposes,  this should stay as “Other” so we are not mischaracterizing the data from the state.'
where release_element_mapping_id = 310 and organization_value = 'CHU'; 
...
insert into release_element_value_mapping (release_element_mapping_id, organization_value, epa_value, programmer_comments) values (310, 'CAR', 'Auto dealership/auto maintenance & repair', '');
insert into release_element_value_mapping (release_element_mapping_id, organization_value, epa_value, programmer_comments) values (310, 'CHU', 'Other', 'Please verify - State mapping says Church');
insert into release_element_value_mapping (release_element_mapping_id, organization_value, epa_value, programmer_comments) values (310, 'COL', 'School', '');
...
insert into release_element_value_mapping (release_element_mapping_id, organization_value, epa_value, programmer_comments) values (310, 'FED', 'Federal government, non-military', '');;
insert into release_element_value_mapping (release_element_mapping_id, organization_value, epa_value, programmer_comments) values (310, 'GAS', 'Retail fuel sales (non-marina)', '');
...
insert into release_element_value_mapping (release_element_mapping_id, organization_value, epa_value, programmer_comments) values (310, 'LOC', 'Other', 'Please verify - State mapping says local govt');
...
insert into release_element_value_mapping (release_element_mapping_id, organization_value, epa_value, programmer_comments) values (310, 'MIL', 'Military', '');
...
insert into release_element_value_mapping (release_element_mapping_id, organization_value, epa_value, programmer_comments) values (310, 'PET', 'Bulk plant storage/petroleum distributor', '');
insert into release_element_value_mapping (release_element_mapping_id, organization_value, epa_value, programmer_comments) values (310, 'PRO', 'Other', 'Please verify - State mapping says Proposed Facility');
...
insert into release_element_value_mapping (release_element_mapping_id, organization_value, epa_value, programmer_comments) values (310, 'STA', 'Other', 'lease verify - State mapping says State govt');
...
select * from release_element_value_mapping where  release_element_mapping_id= 310 and organization_value = 'FED';

update release_element_value_mapping 
set epa_value = 'Federal government, non-military', programmer_comments=null
where  release_element_mapping_id= 310 and organization_value = 'FED';
...
select * from release_element_value_mapping where release_element_mapping_id = '313' and programmer_comments = 'This site is open still and listed the manager name for the site.  Should we map it to Active: general?';

update release_element_value_mapping 
set programmer_comments = null, epa_comments ='Yes, map as active: general'
where release_element_mapping_id = '313' and programmer_comments = 'This site is open still and listed the manager name for the site.  Should we map it to Active: general?';
...
select * from nh_release."nh_release"  where site_name like '%AIRPORT%';
