create or replace view "il_ust"."v_pipe_tank_top_sump_wall_type_xwalk" as
 SELECT a.organization_value,
  ...
  WHERE ((a.ust_control_id = 27) AND ((a.epa_column_name)::text = 'pipe_tank_top_sump_wall_type_id'::text));