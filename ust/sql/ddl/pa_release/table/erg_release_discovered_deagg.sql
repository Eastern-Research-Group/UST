CREATE TABLE pa_release.erg_release_discovered_deagg (
...
CREATE UNIQUE INDEX erg_release_discovered_deagg_pkey ON pa_release.erg_release_discovered_deagg USING btree (erg_release_discovered_deagg_id)

CREATE UNIQUE INDEX erg_release_discovered_deagg_unique ON pa_release.erg_release_discovered_deagg USING btree ("RELEASE_DISCOVERED")