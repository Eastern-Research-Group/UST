create or replace view "ok_ust"."v_tank_secondary_containment_xwalk" as
 SELECT a.organization_value,
  ...
  WHERE ((a.ust_control_id = 23) AND ((a.epa_column_name)::text = 'tank_secondary_containment_id'::text));