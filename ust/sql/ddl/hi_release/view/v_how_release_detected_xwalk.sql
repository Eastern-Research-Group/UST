create or replace view "hi_release"."v_how_release_detected_xwalk" as
 SELECT a.organization_value,
  ...
  WHERE ((a.release_control_id = 14) AND ((a.epa_column_name)::text = 'how_release_detected_id'::text));