CREATE TABLE vt_ust.erg_unregulated_facilities (
...
CREATE UNIQUE INDEX erg_unregulated_facilities_pkey ON vt_ust.erg_unregulated_facilities USING btree (facility_id)