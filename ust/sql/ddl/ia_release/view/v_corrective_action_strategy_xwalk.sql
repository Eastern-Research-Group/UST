create or replace view "ia_release"."v_corrective_action_strategy_xwalk" as
 SELECT a.organization_value,
  ...
  WHERE ((a.release_control_id = 16) AND ((a.epa_column_name)::text = 'corrective_action_strategy_id'::text));