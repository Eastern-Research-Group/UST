CREATE TABLE tn_release.erg_unregulated_releases (
...
CREATE UNIQUE INDEX erg_unregulated_releases_pk ON tn_release.erg_unregulated_releases USING btree (facility_id, release_id)