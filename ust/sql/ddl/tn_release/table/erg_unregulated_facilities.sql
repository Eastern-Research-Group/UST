CREATE TABLE tn_release.erg_unregulated_facilities (
...
CREATE UNIQUE INDEX erg_unregulated_facilities_pkey ON tn_release.erg_unregulated_facilities USING btree (facility_id)