CREATE TABLE de_ust.erg_unregulated_facilities (
...
CREATE UNIQUE INDEX erg_unregulated_facilities_pkey ON de_ust.erg_unregulated_facilities USING btree (facility_id)