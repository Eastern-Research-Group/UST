CREATE TABLE me_ust.erg_unregulated_facilities (
...
CREATE UNIQUE INDEX erg_unregulated_facilities_pkey ON me_ust.erg_unregulated_facilities USING btree (facility_id)