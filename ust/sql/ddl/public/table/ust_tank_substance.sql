...
ALTER TABLE public.ust_tank_substance ADD CONSTRAINT ust_tank_substance_factanksub_unique UNIQUE (ust_tank_id, substance_id);
...
CREATE UNIQUE INDEX ust_tank_substance_factanksub_unique ON public.ust_tank_substance USING btree (ust_tank_id, substance_id)