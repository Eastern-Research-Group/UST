create or replace view "ca_ust"."v_pipe_tank_top_sump_wall_type_xwalk" as
 SELECT a.organization_value,
  ...
  WHERE ((a.ust_control_id = 18) AND ((a.epa_column_name)::text = 'pipe_tank_top_sump_wall_type_id'::text));