CREATE TABLE nj_ust.erg_unregulated_facilities (
...
CREATE UNIQUE INDEX erg_unregulated_facilities_pkey ON nj_ust.erg_unregulated_facilities USING btree (facility_id)