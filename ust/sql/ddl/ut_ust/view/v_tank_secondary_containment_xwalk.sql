create or replace view "ut_ust"."v_tank_secondary_containment_xwalk" as
 SELECT a.organization_value,
  ...
  WHERE ((a.ust_control_id = 19) AND ((a.epa_column_name)::text = 'tank_secondary_containment_id'::text));