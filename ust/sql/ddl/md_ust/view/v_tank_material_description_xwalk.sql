create or replace view "md_ust"."v_tank_material_description_xwalk" as
 SELECT a.organization_value,
  ...
  WHERE ((a.ust_control_id = 16) AND ((a.epa_column_name)::text = 'tank_material_description_id'::text));