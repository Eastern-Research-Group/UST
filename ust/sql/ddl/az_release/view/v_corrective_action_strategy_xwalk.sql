create or replace view "az_release"."v_corrective_action_strategy_xwalk" as
 SELECT a.organization_value,
  ...
  WHERE ((a.release_control_id = 6) AND ((a.epa_column_name)::text = 'corrective_action_strategy_id'::text));