...
class Template:
	...
	def populate_org_control(self):
		...
		cur = conn.cursor()	
		if not self.organization_id and not self.ust_control_id:
			logger.error('Either organization_id or ust_control_id must be passed')
			exit()
...
def main(organization_id=None, ust_control_id=None, data_only=False):
...
if __name__ == '__main__':   
	organization_id = None
	ust_control_id = 8
	main(organization_id, ust_control_id)
